...
public class WarehouseController {
    ...
    public ResponseEntity<warehousesResponsedto> addwarehouses(@RequestBody warehousesResponsedto dto){
    ...
    public ResponseEntity<warehousesResponsedto> updatewarehouse(@PathVariable Long id,
            @RequestBody warehousesResponsedto w) {
